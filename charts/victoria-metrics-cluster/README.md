...
| vminsert.image.tag | string | `"v1.60.0-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.60.0-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.60.0-cluster"` | Image tag |
