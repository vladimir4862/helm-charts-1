...
| vminsert.image.tag | string | `"v1.58.0-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.58.0-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.58.0-cluster"` | Image tag |
